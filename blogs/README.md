...
*   [Part 1: Oxlint: JS Linter That's Actually Fast Enough to Matter](./Oxlint_JS_Linter_Thats_Actually_Fast_Enough_to_Matter)
...
Articles on utilizing local AI models, building personal RAG pipelines, and integrating AI into the developer workflow.
*   [AI Coding Assistants: Boon or Bane?](./AI_Coding_Assistants_Boon_or_Bane.md)
...
### 🖥️ Browser Internals
Exploring how the browser processes, renders, and displays web pages.
*   [How the Browser Rendering Pipeline Actually Works](./How_the_Browser_Rendering_Pipeline_Actually_Works.md)
